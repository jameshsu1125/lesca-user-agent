  ...
  return I || (I = 1, function(i) {
    ...
    (function(t, n) {
      t(function() {
        ...
        e.FALLBACK_PHONE = "UnknownPhone", e.FALLBACK_TABLET = "UnknownTablet", e.FALLBACK_MOBILE = "UnknownMobile", C = "isArray" in Array ? Array.isArray : function(T) {
        ...
        function E(T, S) {
          ...
          if (!P || !S)
            return !1;
          for (o = S.toLowerCase(), a = 0; a < P; ++a)
            if (o === T[a].toLowerCase())
              return !0;
          return !1;
        }
        function l(T) {
          for (var S in T)
            G.call(T, S) && (T[S] = new RegExp(T[S], "i"));
        }
        function d(T) {
          return (T || "").substr(0, 500);
        }
        (function() {
          var S, o, a, P, b, A, M = e.mobileDetectRules;
          for (S in M.props)
            if (G.call(M.props, S)) {
              for (o = M.props[S], C(o) || (o = [o]), b = o.length, P = 0; P < b; ++P)
                a = o[P], A = a.indexOf("[VER]"), A >= 0 && (a = a.substring(0, A) + "([\\w._\\+]+)" + a.substring(A + 5)), o[P] = new RegExp(a, "i");
              M.props[S] = o;
            }
          l(M.oss), l(M.phones), l(M.tablets), l(M.uas), l(M.utils), M.oss0 = {
            WindowsPhoneOS: M.oss.WindowsPhoneOS,
            WindowsMobileOS: M.oss.WindowsMobileOS
          };
        })(), e.findMatch = function(T, S) {
          for (var o in T)
            if (G.call(T, o) && T[o].test(S))
              return o;
          return null;
        }, e.findMatches = function(T, S) {
          var o = [];
          for (var a in T)
            G.call(T, a) && T[a].test(S) && o.push(a);
          return o;
        }, e.getVersionStr = function(T, S) {
          var o = e.mobileDetectRules.props, a, P, b, A;
          if (G.call(o, T)) {
            for (a = o[T], b = a.length, P = 0; P < b; ++P)
              if (A = a[P].exec(S), A !== null)
                return A[1];
          }
          return null;
        }, e.getVersion = function(T, S) {
          var o = e.getVersionStr(T, S);
          return o ? e.prepareVersionNo(o) : NaN;
        ...
        }, e.prepareDetectionCache = function(T, S, o) {
          if (T.mobile === n) {
            var a, P, b;
            ...
            if (a = e.findMatch(e.mobileDetectRules.phones, S), a) {
              T.mobile = T.phone = a, T.tablet = null;
              return;
            }
            e.isMobileFallback(S) ? (b = r.isPhoneSized(o), b === n ? (T.mobile = e.FALLBACK_MOBILE, T.tablet = T.phone = null) : b ? (T.mobile = T.phone = e.FALLBACK_PHONE, T.tablet = null) : (T.mobile = T.tablet = e.FALLBACK_TABLET, T.phone = null)) : e.isTabletFallback(S) ? (T.mobile = T.tablet = e.FALLBACK_TABLET, T.phone = null) : T.mobile = T.tablet = T.phone = null;
          }
        ...
        function r(T, S) {
          this.ua = d(T), this._cache = {}, this.maxPhoneWidth = S || 600;
        }
        return r.prototype = {
          constructor: r,
          /**
           ...
           */
          userAgent: function() {
            return this._cache.userAgent === n && (this._cache.userAgent = e.findMatch(e.mobileDetectRules.uas, this.ua)), this._cache.userAgent;
          },
          /**
           ...
           */
          userAgents: function() {
            return this._cache.userAgents === n && (this._cache.userAgents = e.findMatches(e.mobileDetectRules.uas, this.ua)), this._cache.userAgents;
          },
          /**
           ...
           */
          os: function() {
            return this._cache.os === n && (this._cache.os = e.detectOS(this.ua)), this._cache.os;
          },
          /**
           ...
           */
          is: function(T) {
            return E(this.userAgents(), T) || s(T, this.os()) || s(T, this.phone()) || s(T, this.tablet()) || E(e.findMatches(e.mobileDetectRules.utils, this.ua), T);
          },
          /**
          ...
          mobileGrade: function() {
            return this._cache.grade === n && (this._cache.grade = e.mobileGrade(this)), this._cache.grade;
          }
        }, typeof window < "u" && window.screen ? r.isPhoneSized = function(T) {
          return T < 0 ? n : e.getDeviceSmallerSide() <= T;
        } : r.isPhoneSized = function() {
        }, r._impl = e, r.version = "1.4.5 2021-03-13", r;
      });
    })(function(t) {
      if (i.exports)
        return function(n) {
...
var c = u();
const H = /* @__PURE__ */ D(c);
var V = /* @__PURE__ */ ((i) => (i[i.Desktop = 0] = "Desktop", i[i.Mobile = 1] = "Mobile", i))(V || {});
const N = (i = !1) => {
  let t = new H(window.navigator.userAgent);
  return t.tablet() ? i ? 0 : 1 : t.mobile() ? 1 : 0;
}, L = () => {
  const i = navigator.userAgent || navigator.vendor;
  return i.indexOf("FBAN") > -1 || i.indexOf("FBAV") > -1;
}, m = () => new H(window.navigator.userAgent).os() == "iOS", O = () => new H(window.navigator.userAgent).os() == "AndroidOS", h = () => {
  const i = navigator.userAgent || navigator.vendor;
  return i.indexOf("Line") > -1 || i.indexOf("Line") > -1;
}, R = () => (navigator.userAgent || navigator.vendor).indexOf("Mac OS X") > -1, X = () => (navigator.userAgent || navigator.vendor).indexOf("Mac OS X") < 0, p = { get: N, facebook: L, ios: m, android: O, line: h, mac: R, pc: X };
export {
  V as UserAgentType,
  p as default
};
